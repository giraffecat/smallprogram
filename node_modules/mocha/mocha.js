...
/**
 * Initialize a new `studentgradesystem` reporter.
 *
 * @param {Runner} runner
 * @api public
 */
...
function filterLeaks(ok, globals) {
  return filter(globals, function(key){
    ...
    // Opera and IE expose global variables for studentgradesystem element IDs (issue #243)
